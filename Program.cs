...
builder.Services.AddDbContext<ContextFile>(options => options.UseSqlServer(
...
builder.Services.AddScoped<IUtilRepository, UtilRepository>();
builder.Services.AddScoped<IUtilService,UtilService>();
builder.Services.AddScoped<IUserStoriesRepository, UserStoriesRepository>();
